...
import pic from "../../public/sri1.jpg";
    ...
    <div name="Home" className="max-w-screen-2*1 container mx-auto px-4 md:px-20 my-20">
       <div className='flex flex-col md:flex-row'> 
            <div className='md:w-1/2 mt-12 md:mt-24 space-y-2 order-2 md:order-1'>
                ...
                <br />
                <div>
                    <h1 className='font-bold text-2xl md:text-4xl '>My name is <span className='text-red-700 font-bold text-2xl md:text-4xl' >Sriyanshu Awasthi</span></h1>
                </div>
                <br/>
                ...
                <div className='space-y-2'>
                    ...
                    <ul className='flex space-x-5'>
                        ...
                        <li>
                            <a href="https://github.com/Aesthetic-ai" target='_blank'>
