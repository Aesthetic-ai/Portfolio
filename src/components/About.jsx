        ...
        <div name="About" className='max-w-screen-2*1 container mx-auto px-4 md:px-20 my-16'>
         ...
         <div className='md:w-1/1 mt-2 md:mt-1 space-y-2 '>
            <div>
                ...
                <h1 className='text-red-700 font-bold text-2xl md:text-4xl ml-4'>Sriyanshu Awasthi</h1>
                <br/>
                <h1 className='ml-14 text-2xl'>Wanna know <span  className='text-red-700 font-bold'>Me</span></h1>
                <br/>
                <p className='text-justify'>Hi Everyone, I am <span  className='text-red-700 font-bold'>Sriyanshu Awasthi </span>from<span  className='text-red-700 font-bold'> Lucknow, India.</span>
